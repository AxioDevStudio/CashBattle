    ...
    return (
        <main className="login-page">
            <section className="login-header">
                ...
                <p>
                    Disciplina hoje, <strong>liberdade</strong> amanhã.
                </p>
            </section>
            ...
            <section className="features">
                <div>
                    <span>🎯</span>
                    <h3>Metas</h3>
                    <p>Defina e conquiste seus objetivos</p>
                </div>

                <div>
                    <span>👥</span>
                    <h3>Desafios</h3>
                    <p>Participe de batalhas e ganhe prêmios</p>
                </div>
            ...
            <p className="security">🔒 Seus dados estão protegidos com segurança.</p>
        </main>
    );
}
